...
class ConversationStore:
    ...
    def ensure_seeded(
        self,
        chat_id: str,
        seed_items: list[tuple[str, TResponseInputItem]],
    ) -> bool:
    ...
    def append_items(
        ...
        *,
        ...
        run_id: str | None,
        turn_id: str | None,
        items: list[TResponseInputItem | Mapping[str, Any]],
        source: str,
        replayable: bool,
    ...
    def list_openai_context_items(
        ...
        *,
        ...
        selected_reversed: list[list[TResponseInputItem]] = []
        text_chars = 0
        media_chars = 0
        item_count = 0
        ...
        selected: list[TResponseInputItem] = []
